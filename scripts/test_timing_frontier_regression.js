...
async function main() {
  ...
  const actual = {
    ...
    state_by_primary_wave: stateByPrimaryWave,
    anchor_occupations: anchors
  };

  if (updateSnapshot) {
    fs.writeFileSync(SNAPSHOT_PATH, `${stableStringify(actual)}\n`, 'utf8');
