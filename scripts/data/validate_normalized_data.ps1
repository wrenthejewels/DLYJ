...
$headerMap = @{
    ...
    'occupation_demand_adoption_context.csv' = @('occupation_id','demand_expansion_context','labor_demand_context','labor_tightness_context','ai_adoption_context','adoption_realization_context','labor_context_confidence','adoption_context_confidence','context_confidence','btos_covered_sector_share','source_mix','notes','demand_floor_suppression')
    'occupation_recomposition_context.csv' = @('occupation_id','workflow_compression_context','organizational_conversion_context','next_scenario_lift','distant_scenario_lift','organizational_adoption_ceiling','economic_pressure_context','wave_acceleration_context','displacement_wave_bias','recomposition_context_confidence','source_mix','notes')
    ...
    'occupation_structural_calibration_targets.csv' = @('occupation_id','title','human_constraint_target','human_constraint_confidence','adoption_context_target','adoption_context_confidence','demand_context_target','demand_context_confidence','wage_leverage_target','wage_leverage_confidence','routine_pressure_target','routine_pressure_confidence','recomposition_context_target','recomposition_context_confidence','wave_timing_target','wave_timing_confidence','specialization_resilience_target','specialization_resilience_confidence','role_heterogeneity_target','role_heterogeneity_confidence','model_human_guardrail','model_adoption_context','model_demand_context','model_wage_leverage','model_routine_pressure','model_recomposition_context','model_wave_timing','model_specialization_resilience','model_role_fragmentation','human_constraint_gap','adoption_context_gap','demand_context_gap','wage_leverage_gap','routine_pressure_gap','recomposition_context_gap','wave_timing_gap','specialization_resilience_gap','role_heterogeneity_gap','human_constraint_review','adoption_context_review','demand_context_review','wage_leverage_review','routine_pressure_review','recomposition_context_review','wave_timing_review','specialization_resilience_review','role_heterogeneity_review','observed_individual_exposure','individual_vs_org_gap','individual_usage_direction','individual_usage_source_flag','individual_usage_confidence','individual_usage_gap','individual_usage_review','external_context_exception','external_context_note','quality_source_mix','ors_source_mix','heterogeneity_source_mix','btos_source_mix','adaptation_source_mix','labor_release_year','highest_review_tier','primary_review_layer','primary_review_strength','primary_review_score','primary_review_reason','notes')
...
Assert-ForeignKey -Rows $demandAdoptionContext -Column 'occupation_id' -Allowed $occupationIds -Label 'demand/adoption context occupation_id'
Assert-ForeignKey -Rows $recompositionContext -Column 'occupation_id' -Allowed $occupationIds -Label 'recomposition context occupation_id'
