...
- the live reviewed posting layer now carries `472` rows across those `64` occupations
- density is still uneven: `20` occupations currently have `4` reviewed rows, `35` have `8`, `8` have `12`, and `1` has `16`
