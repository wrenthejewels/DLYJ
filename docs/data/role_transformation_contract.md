...
- the live reviewed posting layer now carries `392` rows across those `64` occupations
- density is still uneven: `32` occupations currently have `4` reviewed rows, `30` have `8`, and `2` have `12`
