...
- the live reviewed posting layer now carries `512` rows across those `64` occupations
- density is still uneven: `10` occupations currently have `4` reviewed rows, `45` have `8`, `8` have `12`, and `1` has `16`
