...
- the live reviewed posting layer now carries `412` rows across those `64` occupations
- density is still uneven: `27` occupations currently have `4` reviewed rows, `35` have `8`, and `2` have `12`
