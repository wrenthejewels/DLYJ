...
- the live reviewed posting layer now carries `432` rows across those `64` occupations
- density is still uneven: `25` occupations currently have `4` reviewed rows, `35` have `8`, `3` have `12`, and `1` has `16`
