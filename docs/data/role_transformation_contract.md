...
- the live reviewed posting layer now carries `372` rows across those `64` occupations
- density is still uneven: `36` occupations currently have `4` reviewed rows, `27` have `8`, and `1` has `12`
