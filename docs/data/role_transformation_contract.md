...
- the live reviewed posting layer now carries `452` rows across those `64` occupations
- density is still uneven: `24` occupations currently have `4` reviewed rows, `32` have `8`, `7` have `12`, and `1` has `16`
