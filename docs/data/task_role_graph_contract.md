...
- `1825` task rows in `data/normalized/occupation_task_inventory.csv`
- `64` modeled occupations currently have task-inventory rows
- average `28.5` rows per covered occupation
- minimum `24`
- maximum `38`
...
- `Computer User Support Specialists` (`24`)
- `Data Scientists` (`24`)
- `Civil Engineers` (`24`)
...
- the reviewed job-description layer now carries `432` rows: `25` occupations at `4` reviewed rows, `35` at `8`, `3` at `12`, and `1` at `16`
