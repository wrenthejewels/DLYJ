...
- once the task-graph recomposition path is active, the live engine now lets the outer recomposition context pull somewhat harder than earlier builds did: the final task-graph-stage blend is `0.56 / 0.44` for workflow compression and `0.64 / 0.36` for organizational conversion
